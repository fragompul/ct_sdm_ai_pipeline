...
class TopologicalRouter:
    ...
    def _build_stacking_ensemble(self):
        ...
        base_learners = [
            # Eliminado use_label_encoder por obsolescencia en versiones recientes de XGBoost
            ('xgb', xgb.XGBClassifier(eval_metric='mlogloss', random_state=self.random_state)),
